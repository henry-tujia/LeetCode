...
class Solution:
    def openLock(self, deadends: List[str], target: str) -> int:
        ...
        def chooses(state):
            ...
            for index,item in enumerate((x, y, z, w)):
                a = int(item)
                a_0,a_1 = a+1,a-1
                if a_1 == -1:
                    a_1 = 9
                ...
                for i in [a_0,a_1]:
                    temp = [x, y, z, w]
                    temp[index] = str(i)
                    if "".join(temp) in deadends or tuple(temp) in visited :
                        continue
        ...
        while q:
            for _ in range(len(q)):
                ...
                if (x, y, z, w) in visited:
                    continue
                visited.add((x, y, z, w))
                if "".join((x, y, z, w)) == target:
                    return depth
                for choose in chooses(state=(x, y, z, w)):
                    q.append(choose)
            depth += 1
        return -1
